<x-app-layout>
    <div class="pt-6 pb-8 space-y-2 md:space-y-5">
        <h1 class="text-3xl font-extrabold leading-9 tracking-tight text-gray-900 dark:text-gray-100 sm:text-4xl sm:leading-10 md:text-6xl md:leading-14">Blog posts</h1>
        ...
        <div class="container px-5 py-24 mx-auto">
            ...
            @foreach ($posts as $post)    
                <div class="flex flex-wrap py-8 md:flex-nowrap">
                    ...
                    <a href="{{ route('post.show', $post) }}" class="inline-flex items-center mt-4 text-green-500 hover:text-green-600">Read More
