                    ...
                    <form method="POST" action="{{ route('admin.posts.update', $post) }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <input
                                ...
                                id="title" name="title" required value="{{ old('title', $post->title) }}" type="text"
                        ...
                        <div class="mb-4">
                            ...
                            <input
                                ...
                                id="tags" name="tags" type="text" value="{{ old('tags', $tags) }}"
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                placeholder="Write your thoughts here">{{ old('post', $post->post) }}</textarea>
                            @error('post')
                            <span class="font-medium text-red-600" role="alert">{{ $message }}</span>
                            @enderror
                        </div>
